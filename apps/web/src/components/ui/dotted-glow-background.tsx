...
interface DottedGlowBackgroundProps {
  ...
  speedScale?: number;
  /** animate glow pulses; false draws a static frame and only redraws on resize */
  animated?: boolean;
}
...
function initCanvasAnimation(
  ...
  const handleResize = () => {
    resize();
    regenDots();
    drawFrame({ ctx, el, container, dots, now: performance.now(), config });
  };
...
export const DottedGlowBackground = ({
  ...
  useEffect(() => {
    ...
    return initCanvasAnimation(el, container, config, animated);
  }, [
    animated,
    gap,
    radius,
