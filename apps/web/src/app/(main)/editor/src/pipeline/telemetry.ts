...
export const telemetry = {
  ...
  recordAgentReviewStart: (
    ...
    telemetryLogger.telemetry("final-review-start", { importOpId, ...data });
  },
  ...
  recordAgentReviewComplete: (
    ...
    telemetryLogger.telemetry("final-review-complete", { importOpId, ...data });
  },

  recordAgentReviewError: (importOpId: string, error: string): void => {
    telemetryLogger.error("final-review-error", { importOpId, error });
  },
